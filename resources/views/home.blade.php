...
<section class="intro" aria-labelledby="intro-title">
    <p class="eyebrow">THE VISUAL PAGE EDITOR FOR LARAVEL</p>
...
<section class="hero-preview" aria-label="Studio template preview">
    ...
    <div class="hero-caption"><span class="eyebrow">STUDIO FORMA</span><p>A practice in<br><em>possibility.</em></p><span class="hero-caption-note">A real page. Ready for your ideas.</span></div>
    ...
    <div class="template-grid">
        @foreach ($templates as $identifier => $template)
            <article class="template-item">
                ...
                <h3 class="template-heading">{{ $template['name'] }}</h3><p>{{ $template['description'] }}</p>
            </article>
        @endforeach
    </div>
...
<section class="process-section" aria-labelledby="process-title">
    ...
    <ol class="process-list"><li><h3>Shape it.</h3><p>Click a block. Write a headline. Move a section. Undo an idea and try another.</p></li><li><h3>Make it yours.</h3><p>Choose a photograph, add a link, or upload your own. Your copy belongs to your browser.</p></li><li><h3>Put it out there.</h3><p>Save your draft and publish. Open a real page, with a link that lasts as long as your demo.</p></li></ol>
</section>
